<%@ Page Title="Add Books" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddBooks.aspx.cs" Inherits="ELibrary.AddBooks" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="add-books-container">
        ...
        <div class="form-group">
            ...
            <asp:TextBox ID="txtPrice" min="0" runat="server" CssClass="form-control" placeholder="Enter price" TextMode="Number" step="0.01" required></asp:TextBox>
        </div>
        <div class="form-group">
